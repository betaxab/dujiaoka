...
return [
    ...
    'join_qq_group' => '加入 QQ 群',
    'join_telegram_group' => '加入 TG 群',
    'is_open' => '是否启用',
    'trashed' => '回收站',
    'restore' => '恢复',
    ...
    'status_pending_number' => '待处理',
    'status_processing_number' => '处理中',
    'status_completed_number' => '已完成',
    'status_failure_number' => '失败',
    'status_abnormal_number' => '异常',

    'payment_chart' => '支付数据',
    'payment_successful_number' => '支付成功',
    'unpaid_number' => '未支付',
    ...
    'confirm_order' => '确认订单',
    'date_to_expired_order' => ':min 分钟内未完成支付订单将作废',
    ...
    'pay_order_expiration_date_prompt' => '请打开 APP 扫码支付！有效期 :min 分钟',
    'money_symbol' => '¥',
    'purchase_limit' => '每单限',
    ...
    'equipment' => [
        ...
        'does_not_support_wechat_or_qq_access' => '本站不支持 微信或 QQ 内访问',
        'please_follow_the_prompts_to_open' => '请按提示在手机用 浏览器 打开',
        'open_browser_tips' => '点击右上角···图标或复制网址自行打开',
        'apple_device' => '苹果设备',
        'android_device' => 'Android 设备',
        'click_on_the_upper_right_corner' => '点击右上角',
        'open_the_browser' => '用 浏览器 打开',
